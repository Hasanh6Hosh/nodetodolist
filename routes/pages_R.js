...
router.get('/cat',(req,res)=>{res.sendFile(path.join(__dirname,"..","public","pages","cat.html"))})
router.get('/user',(req,res)=>{res.sendFile(path.join(__dirname,"..","public","pages","users.html"))})
